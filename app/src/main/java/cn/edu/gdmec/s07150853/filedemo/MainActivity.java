package cn.edu.gdmec.s07150853.filedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private File fExternalStoragePublicDiretory;
    private File fExternalStorageDiretory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fExternalStoragePublicDiretory= Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MUSIC);
        fExternalStorageDiretory=Environment.getExternalStorageDirectory();
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_REMOVED)) {
            Button btn = (Button) findViewById(R.id.externalStorageDiretory);
    ...
    public void externalStoragePublicDiretory(){
        path=fExternalStoragePublicDiretory.getAbsolutePath();
        listFiles(path);

    }
    public void externalStorageDiretory(){
        path=fExternalStorageDiretory.getAbsolutePath();
        listFiles(path);
    }
